...
<html lang="es" class="h-full dark">
    <head>
        ...
        <title>Página no encontrada | RentaDrive</title>
    ...
    <body class="flex min-h-full items-center justify-center bg-[#030914] px-6 py-12 text-white">
        <main class="w-full max-w-2xl text-center">
            ...
            <p class="mt-8 text-sm font-black uppercase tracking-[.35em] text-blue-400">Error 404</p>
            <h1 class="mt-4 text-4xl font-black tracking-tight sm:text-6xl">La ruta quedó fuera del circuito.</h1>
            ...
            <div class="mt-8 flex flex-wrap justify-center gap-3">
                ...
                <button type="button" class="btn-secondary" onclick="history.back()">Regresar</button>
            </div>
        </main>
    </body>
</html>
